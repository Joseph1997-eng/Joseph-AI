        ...
        with col2:
            ...
            with tab2:
                with st.form("register_form"):
                    ...
                    np = st.text_input("🔒 Password Thar", type='password', placeholder="Password Tialnak")
                    np2 = st.text_input("🔒 Confirm Password", type='password', placeholder="Password Tial Thannak")
